...
import IRole, {ERolePermisions} from "../models/IRole";
...
try {
    ...
    const name: any  = role.name;
    const permisions: Array<ERolePermisions> = role.permisions;
    const serviceResult = await RoleService.createRole({name, permisions});
